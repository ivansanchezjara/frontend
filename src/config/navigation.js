...
export const erpModules = [
  ...
  // --- CATEGORÍA: FINANZAS ---
  {
    ...
    icon: "🏦",
    title: "Tesorería",
    desc: "Cuentas financieras, saldos, movimientos, cheques y conciliación.",
    color: "purple",
    estado: "activo",
    roles: ["Admin"],
  },
  ...
  },
  {
    ...
    icon: "💰",
    title: "Ingresos",
    desc: "Cobranzas de clientes, pagos recibidos y cuentas por cobrar.",
    color: "purple",
    estado: "activo",
    roles: ["Admin"],
  },
  {
    ...
    icon: "💸",
    title: "Egresos",
    desc: "Registro y control de gastos operativos y pagos a proveedores.",
    color: "purple",
    estado: "activo",
    roles: ["Admin"],
  },
  {
    ...
    icon: "📊",
    title: "Reportes",
    desc: "Flujo de caja, utilidades, indicadores financieros y comparativos.",
    color: "purple",
    estado: "activo",
    roles: ["Admin"],
  },
