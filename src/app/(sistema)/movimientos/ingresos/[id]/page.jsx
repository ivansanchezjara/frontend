            ...
            <div className="flex flex-col md:flex-row justify-between items-start gap-4">
                <div>
                    ...
                    <h1 className="text-3xl font-black text-slate-900 tracking-tight flex items-center gap-3">
                        <div className="w-10 h-10 bg-blue-600 rounded-xl flex items-center justify-center text-white"><Save size={24} /></div>
                        Editando Ingreso #{id}
                    </h1>
                </div>
                ...
                <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm flex items-center gap-6">
                    ...
                    <button disabled={isSubmitting || !!errorMsg} onClick={handleSubmit} className={`px-8 py-3 rounded-xl font-black text-sm transition-all active:scale-95 ${errorMsg ? 'bg-slate-200 text-slate-400 cursor-not-allowed' : 'bg-blue-600 hover:bg-blue-700 text-white shadow-xl shadow-blue-100'}`}>
