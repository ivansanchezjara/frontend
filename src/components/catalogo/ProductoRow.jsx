...
export default function ProductoRow({ producto }) {
    ...
    return (
        <tr
            ...
            className="border-t border-slate-100 hover:bg-blue-50/50 transition-colors cursor-pointer group"
        >
                ...
                <td className="py-3 pr-6 pl-4 text-right">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor"
                        className="w-4 h-4 text-slate-300 group-hover:text-blue-400 group-hover:translate-x-0.5 transition-all inline-block">
