        ...
        {form.nivel === 'variante' ? (
          <Field label="Variante">
            <input
              ...
              className="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm mb-2 bg-slate-50 outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 focus:bg-white transition-all"
            />
            <select
              value={form.variante || ''}
